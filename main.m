...
parameter.mode = 2; % Data generation   1:Ultimatum game   2£ºLorentz
...
% kalman filter compressive sensing method
% It can only be used when the dynamics is Lorenz dynamics
...
[AUROC_Kalman,AUPR_Kalman,prec_Kalman, tpr_Kalman, fpr_Kalman, thresh] = prec_rec(score, target, 'holdFigure',1);
prec_rec(score, target, 'holdFigure',2);
